...
public class Configuracion {
    ...
    public Configuracion(String[] args) {
        ...
        archivo = propiedades.getProperty(
                "archivo",
                "datos/datos.csv");

        separador = propiedades.getProperty(
                "separador",
                ",");

        directorioSalida = propiedades.getProperty(
                "directorioSalida", "salida");

        directorioSalida = System.getenv()
                .getOrDefault(
                        "ANALIZADOR_OUTPUT",
                        directorioSalida);
    ...
    private Properties cargarPropiedades() {
        ...
        try (
            ...
            System.out.println(
                    "Archivo de configuración no disponible.");
        }
